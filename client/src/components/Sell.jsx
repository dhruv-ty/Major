...
const SellFields = ({label, value}) => (
    ...
    <div className="flex flex-row w-full items-center justify-center">
        ...
        <div className="rounded-lg bg-[#26262a] w-5/6 mt-5">
            <input type="text" style={{background: "#26262a", border: 0, width: "100%", borderRadius: 10, color: "#9ca3af"}} defaultValue={value} />                
        </div>
    </div>
        ...
        <div className="flex flex-row w-full mt-20 justify-center items-center">
            <div className="flex flex-col w-1/2 justify-center items-center">
                ...
                <div className="flex flex-row w-full items-start mt-5 justify-center">
                    ...
                    <div className="rounded-lg bg-[#26262a] w-5/6 mt-5 ml-3">
                        <textarea rows="5" style={{background: "#26262a", border: 0, width: "100%", borderRadius: 10, color: "#9ca3af"}} placeholder="Enter some description">
                            </textarea>             
                    </div>
                </div>
